      ...
      <div>
        ...
        <div className="card" style={{ padding: '18px 20px' }}>
          <p style={{ margin: 0, fontSize: '0.5em', lineHeight: 1.5 }}>
            ...
            <br />
            Pulls last-24h signal from Tavily + web search + targeted Reddit communities.
          </p>
        </div>
        <div className="card" style={{ padding: '18px 20px', marginTop: 12 }}>
          <p style={{ margin: 0, fontSize: '0.5em', lineHeight: 1.5 }}>
            ...
            <br />
            Checks 7 days of <code style={{ color: 'var(--accent-purple)' }}>daily_brief_archive.md</code> and filters duplicates before writing.
          </p>
        </div>
        <div className="card" style={{ padding: '18px 20px', marginTop: 12 }}>
          <p style={{ margin: 0, fontSize: '0.5em', lineHeight: 1.5 }}>
            <strong style={{ color: '#fff' }}>Ready-to-read output in ~3 minutes</strong>
            <br />
            Telegram-formatted digest with inline links, then auto-appended to archive.
          </p>
        </div>
      </div>
    </div>
